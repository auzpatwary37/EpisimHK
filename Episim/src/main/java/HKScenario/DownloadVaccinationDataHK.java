...
public class DownloadVaccinationDataHK implements Callable<Integer> {
	...
	private static Logger log = LogManager.getLogger(DownloadVaccinationDataHK.class);
	...
	public static void main(String[] args) {
		System.exit(new CommandLine(new DownloadVaccinationDataHK()).execute(args));
	}

 ...
 */
public class CreateRestrictionsFromMobilityDataMontreal implements RestrictionInput {
	...
	private final static Map<String, List<String>> MAPPING = Map.of(
			...
			"workplaces", List.of("work","education")
	);
	...
	@Override
	public CreateRestrictionsFromMobilityDataMontreal setInput(Path input) {
		this.input = input;
		return this;
	}
}
